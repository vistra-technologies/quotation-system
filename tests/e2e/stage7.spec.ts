...
// NOTE (Stage 19 Batch 5): ComponentType JSON toggle tests removed — relocated to
// superadmin-component-types.spec.ts. Component Type management moved to
// /controls/component-types (SuperAdmin console).
