/**
 * Loading skeleton for the admin external-companies route group.
 * Displayed while the Server Component fetches session + company data.
 */
export default function ExternalCompaniesLoading() {
  return (
    <div className="animate-pulse">
      ...
      <div className="mt-6 rounded-md border border-border bg-bg-card">
        {[1, 2, 3].map((i) => (
          ...
          >
            <div className="h-4 flex-1 rounded-sm bg-border" />
