/**
 * Quotation step — loading UI (Suspense boundary).
 *
 * Shown while the server renders the quotation page (fetchProjectDetail + step-gate
 * check). Eliminates the blank-screen pause when navigating to the Quotation step.
 *
  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="mb-6 flex flex-col items-center gap-2">
        ...
        <div className="h-4 w-64 rounded-sm bg-primary-softer" />
      </div>
      ...
      <div className="mb-6 rounded-md border border-border bg-bg-card shadow-card">
        <div className="m-5 rounded-md border border-dashed border-border px-6 py-16 flex flex-col items-center gap-3">
          ...
          <div className="h-3 w-60 rounded-sm bg-border/40" />
        </div>
      </div>
