  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="mb-6 flex flex-col items-center gap-2">
        <div className="h-8 w-44 rounded bg-zinc-200 dark:bg-zinc-700" />
      ...
      <section className="mb-8">
        ...
        <div className="rounded-md border border-border bg-bg-card shadow-card">
          {[...Array(3)].map((_, i) => (
            ...
            >
              <div className="h-4 w-6 rounded bg-zinc-100 dark:bg-zinc-800" />
      ...
      <section>
        <div className="mb-3 h-4 w-36 rounded bg-zinc-200 dark:bg-zinc-700" />
